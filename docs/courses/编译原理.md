...
- 由文法$G$的开始符号$S$推出的所有**句子**构成的集合称为**文法G生成的语言**，记作$L(G)$
...
<div style="text-align:center;"><img src="compiler.assets/14.png" style="zoom: 50%;box-shadow: rgba(0, 0, 0, 0.5) 10px 10px 10px; border-radius: 10px;" /></div>
